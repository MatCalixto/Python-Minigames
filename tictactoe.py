...
while playagain == 1:
 ...
 print("")
 language = int(input("First or second language - Língua 1 ou 2: ")) #language
 print("")
 if language == 2:
    print("TIC-TAC-TOE PvP - Player vs Player")
    print("Made by Matheus Calixto")
 else:
    print("Jogo da Velha PvP - Jogador vs Jogador")
 ...
 print("")
 if language == 2:
    firstplayername = str(input("First player's name is: "))
 else:
    firstplayername = str(input("O nome do primeiro jogador é: ")) #ask user name
 print("")
 if language == 2:
    secondplayername = str(input("Second player's name is: "))
 else:
    secondplayername = str(input("O nome do segundo jogador é: "))
 print("")
 ...
 while numberofgames < 9: #while less than 9 games have been played
    if player == 0:
       if language == 2:
          move = str(input(firstplayername + " (X)'s turn: ")) #where will he put a cross
          print("")
       else:
       ...
       if language == 2:
          move = str(input(secondplayername + " (O)'s turn: ")) #where will he put a ball
          print("")
       else:
    ...
    if move == "a1": #find the square
       if a1 == " X" or a1 == " O":
           if language == 2:
              print("Invalid position, that square is already taken, try again")#player chose
           else:                                                                #used square
    ...
    if (a1 == " X" and a2 == " X" and a3 == " X" or #did player 1 win the game?
        ...
        print("")
        if language == 2:
          print(firstplayername + " won the game, congrats!")
          print("")
        else:
          print(firstplayername + " ganhou o jogo, parabéns!")
          print("")
        numberofgames = 15
    if (a1 == " O" and a2 == " O" and a3 == " O" or #did player 2 win the game?
        ...
        print("")
        if language == 2:
          print(secondplayername + " won the game, congrats!")
          print("")
        else:
          print(secondplayername + " ganhou o jogo, parabéns!")
          print("")
        numberofgames = 15
    print("       1    2    3 ")
